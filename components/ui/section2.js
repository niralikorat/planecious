...
future the planet deserves.</p>
          <p className='text-5xl font-semibold text-center'>An initiative for change by aligning</p>
      ...
      <div className='bgSection3 flex flex-col py-32 md:px-20 gap-4 items-center text-white'>
        ...
        <Link className='bgPrimary px-6 py-4 rounded-3xl text-xs font-semibold text-white mt-2 hover:scale-105' href={'https://www.linkedin.com/groups/8147680/'}>JOIN HERE</Link>
      </div>
      <section className='flex flex-col lg:flex-row justify-evenly h-full lg:h-[70vh]' id='Initiatives'>
        <div className='flex flex-col w-full'>
          <div className='flex flex-col gap-4 py-10 px-10 lg:px-20 justify-center h-full '>
          <p className='font-semibold text-4xl text-black   text-start'>Key to a More Eco-friendly world !!!</p>
